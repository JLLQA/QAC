...
const Rating12A = () => {
    return (
        <div>
            ...
            <CardImg id="movCert" src="https://static.wikia.nocookie.net/rating-system/images/8/87/BBFC_12A.svg" alt="12A – Suitable for 12 years and over"></CardImg>
            <br />
            <br />
            <Card body>
                <CardText>
                    <h3 align="center">12A – Suitable for 12 years and over</h3>
                    <br />
                    A 12A rated film should not be suitable for children under the age of 12.
