        ...
        <Container>
          ...
          <Container>
            <Card body className="text-center">
              ...
              <Button href="https://www.visitmanchester.com/things-to-see-and-do" target="_blank">For comprehensive information of places to visit in Manchester,
               click here.</Button>
            </Card>
            <br />
            <Card body className="text-center">
              ...
              <Button href="https://printworks-manchester.com/" target="_blank">Visit the 'Printworks' website for more info</Button>
            </Card>
            <br />
            <Card body className="text-center">
              ...
              <Button href="https://manchesterartgallery.org/" target="_blank">Visit the 'Manchester Art Gallery' website for more info</Button>
            </Card>
            <br />
            <Card body className="text-center">
              ...
              <Button href='https://www.visitsealife.com/manchester/' target="_blank">Visit the 'Sea Life Manchester Aquarium' website for more info </Button>
            </Card>
            <br />
            <Card body className="text-center">
